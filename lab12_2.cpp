...
int calScore(int x,int y,int z){
	...
	if(y > 10) y = 0;
	if(z > 10) z = 0;
	return (x+y+z)%10;//Return the score. 
}
...
int main(){	
	...
	int yugiCards[3] = {drawCard(), drawCard(), 0}; //Initialize value of yugiCards[].
	...
	do{
		...
		cin >> playerAction;
	}while(playerAction != 1 && playerAction != 2); //Set the condition to do loop if user's input is not 1 or 2. 
		if(playerAction == 1){
